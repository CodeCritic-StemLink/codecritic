...
| `feature-01-ranking.md` | **The flagship deliverable.** How the personalised feed works, the formula and why each number is what it is, where it runs, what we rejected, its limitations, and how we would improve it. Written to be presented. | 2026-08-14 |
| `feature-02-profiles.md` | How every figure on a profile is calculated and why the queries are correct, including the reviews given versus received trap the SRS calls out. | 2026-08-14 |

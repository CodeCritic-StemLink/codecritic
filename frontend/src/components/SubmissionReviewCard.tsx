...
//
// Named separately from ReviewCard.tsx (Aqeel's, used on profile pages) because that
// component takes different props and renders a link back to the submission, which
// does not make sense on the page the submission itself lives on.
...
export function SubmissionReviewCard({ review }: Props) {
  return (
